                  ...
                  <tbody>
                    {filtered.map(order => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-neutral-950 font-bold">{formatINR(order.total)}</td>
            ...
            <div className="w-72 flex-shrink-0 bg-white border border-neutral-200 rounded-xl p-4 space-y-4 self-start shadow-md">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-neutral-950 font-bold">{formatINR(selectedOrder.total)}</span>
                </div>
                <div className="flex items-center justify-between">
