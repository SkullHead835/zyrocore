        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-[#111] border border-[#1e1e1e] rounded-xl p-5 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              />
              <button type="button" onClick={addImage} suppressHydrationWarning className="bg-[#1e1e1e] hover:bg-[#2a2a2a] text-white rounded-lg px-3 text-sm transition-colors">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {form.images.map(url => (
                  <div key={url} className="relative group">
                    <img src={url} alt="" className="w-16 h-16 object-cover rounded-lg border border-[#2a2a2a]" />
                    <button
                      type="button" onClick={() => removeImage(url)} suppressHydrationWarning
